...
#include "fsm.hh"		/* XXX CPIO_FOO/FSM_FOO constants */
#include "rpmchroot.hh"
#include "rpmfi_internal.hh" /* XXX replaced/states... */
#include "rpmte_internal.hh"	/* XXX internal apis */
#include "rpmdb_internal.hh" /* rpmdbAdd/Remove */
#include "rpmts_internal.hh" /* rpmtsPlugins() etc */
#include "rpmds_internal.hh" /* rpmdsFilterTi() */
